...
function example(filepath, cypressConfiguration, preprocessorConfiguration, expected) {
    it(`should return [${expected.join(", ")}] for ${filepath} with ${util_1.default.inspect(preprocessorConfiguration)} in ${cypressConfiguration.projectRoot}`, () => {
        const actual = (0, step_definitions_1.getStepDefinitionPatterns)({
            cypress: cypressConfiguration,
            preprocessor: new preprocessor_configuration_1.PreprocessorConfiguration(preprocessorConfiguration, {}),
        }, filepath);
        const throwUnequal = () => {
...
describe("getStepDefinitionPatterns()", () => {
    example("/foo/bar/cypress/integration/baz.feature", {
        projectRoot: "/foo/bar",
    ...
    example("/cypress/integration/foo/bar/baz.feature", {
        projectRoot: "/",
        integrationFolder: "cypress/integration",
    }, {
    ...
    it("should error when provided a path not within integrationFolder", () => {
        assert_1.default.throws(() => {
            (0, step_definitions_1.getStepDefinitionPatterns)({
                cypress: {
                    projectRoot: "/foo/bar",
                    integrationFolder: "cypress/integration",
                },
